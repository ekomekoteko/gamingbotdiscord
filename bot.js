...
const reactions = ["ًں’»", "ًں–Œ", "ًںکƒ", "ًں†•"]; Reaction Here | 
const botToken = "التوكين"; /*You'll have to set this yourself; read more // AlphaCodes
...
function generateMessages(){
    ...
    for (let role of roles) messages.push(`React below to get the **"${role}"** role!`); //DONT CHANGE THIS // AlphaCodes 
    return messages;
}
